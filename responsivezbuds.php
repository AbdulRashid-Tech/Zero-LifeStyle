...
<?php
    ...
    <div class="container text-center mt-3 bg-transparent" style="padding:0;">
        <h2>Zbuds Earbuds Price in Pakistan - The Fashion Tech Revolution</h2>
    </div>

    <div class="container-fluid mt-4">
        <div class="row" >
            <?php
            $sql = "SELECT * FROM `zbuds`";
    ...
    <!-- banner1 -->
    <div class="beatmatters">
        <a href="#"><img src="../html/zero data/beat matters.png" alt=""></a>
    </div>
    <!-- banner1 -->

    <!-- banner1 -->
    <div class="ANC">
        <a href="#"><img src="../html/zero data/ANC ENC.png" alt=""></a>
    </div>
    <!-- banner1 -->

    <!-- banner1 -->
    <div class="beatmatters">
        <a href="#"><img src="../html/zero data/zbuds your beat matters.png" alt=""></a>
    </div>
    <!-- banner1 -->
